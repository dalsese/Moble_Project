...
//   strip1.begin();
//   strip.show(); // 램의 픽셀 데이터를 Adafruit_NeoPixel에 전송
//   strip1.show();
// }
...
//   if(WheelPos < 85) {
//    return strip.Color(WheelPos * 3, 255 - WheelPos * 3, 0), strip1.Color(WheelPos * 3, 255 - WheelPos * 3, 0);
//   } else if(WheelPos < 170) {
//    WheelPos -= 85;
//    return strip.Color(255 - WheelPos * 3, 0, WheelPos * 3), strip1.Color(255 - WheelPos * 3, 0, WheelPos * 3);
//   } else {
//    WheelPos -= 170;
//    return strip.Color(0, WheelPos * 3, 255 - WheelPos * 3), strip1.Color(0, WheelPos * 3, 255 - WheelPos * 3);
//   }
// }
